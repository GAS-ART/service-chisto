                    ...
                    <div class="popup__form">
                        <div class="popup__form-body">
                            ...
                            <div class="popup__text">
                                <form action="{{ route('sendMainForm') }}" method="POST" name="popupForm"
                                    {{-- id="mainForm" --}} class="@lang('lang.current')">
                                    @csrf
                                    <input name="page" type="hidden" value="{{ url()->current() }}">
                                    <div class="popup__item">
                                        <label for="popup-name">@lang('popup.name')</label>
                                        <input id="popup-name" name="name" type="text"
                                            placeholder="@lang('popup.name_placeholder')">
                                        <p class="error-name"></p>
                                    </div>
                                    <div class="popup__item">
                                        <label for="popup-phone">@lang('popup.phone')</label>
                                        <input id="popup-phone" name="phone" type="text"
